...
class LeaveRequestView extends GetView<LeaveRequestController> {
  ...
  Widget build(BuildContext context) {
    double widith= MediaQuery.of(context).size.width;
                        ...
                        child: ToggleButtons(
                         ...
                         // selectedBorderColor: Colors.blue,
                          ...
                          borderColor: Colors.transparent,
                           constraints:  BoxConstraints.expand(width:Get.width*.434,height: Get.height*.067 ), //number 2 is number of toggle buttons
